...
public class PhotoPickerActivity extends BasePickerActivity implements PickerAction {
  ...
  public static final String PARAM_NAVI = "PARAM_NAVI";
  ...
  private LinearLayout layout_goBack;
  private RelativeLayout layout_navigation;
  private int navBackGroudResourceId;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    navBackGroudResourceId = getIntent().getIntExtra(PARAM_NAVI, -1);
    initUI();
  }
  ...
  private void initUI() {
    ...
    layout_navigation=(RelativeLayout)findViewById(R.id.layout_navigation);
    layout_navigation.setBackground(getResources().getDrawable(navBackGroudResourceId));
